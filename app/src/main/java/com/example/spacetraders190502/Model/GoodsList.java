...
public enum GoodsList {
    WATER("Water", TechLevel.PreAgriculture, TechLevel.PreAgriculture, TechLevel.Medieval, 30, 3, 4, Resources.LOTSOFWATER, Resources.DESERT, 30, 50, 0),
    FURS("Furs", TechLevel.PreAgriculture, TechLevel.PreAgriculture, TechLevel.PreAgriculture, 250, 10, 10, Resources.RICHFAUNA, Resources.LIFELESS, 230, 280, 1),
    FOOD("Food", TechLevel.Agriculture, TechLevel.PreAgriculture, TechLevel.Agriculture, 100, 5, 5, Resources.RICHSOIL, Resources.POORSOIL, 90, 160, 2),
    ORE("Ore", TechLevel.Medieval, TechLevel.Medieval, TechLevel.Renaissance, 350, 20, 10, Resources.MINERALPOOR, Resources.MINERALRICH, 350, 420, 3),
    GAMES("Games", TechLevel.Renaissance, TechLevel.Agriculture, TechLevel.PostIndustrial, 250, -10, 5, Resources.ARTISTIC, null, 160, 270, 4),
    FIREARMS("Firearms", TechLevel.Renaissance, TechLevel.Agriculture, TechLevel.Industrial, 1250, -75, 100, Resources.WARLIKE, null, 600, 1100, 5),
    MEDICINE("Medicine", TechLevel.EarlyIndustrial, TechLevel.Agriculture, TechLevel.PostIndustrial, 650, -20, 10, Resources.LOTSOFHERBS, null, 400, 700, 6),
    MACHINES("Machines", TechLevel.EarlyIndustrial, TechLevel.Renaissance, TechLevel.Industrial, 900, -30, 5, null, null, 600, 800, 7),
    NARCOTICS("Narcotics", TechLevel.Industrial, TechLevel.PreAgriculture, TechLevel.Industrial, 3500, -125, 150, Resources.WEIRDMUSHROOMS, null, 2000, 3000, 8),
    ROBOTS("Robots", TechLevel.PostIndustrial, TechLevel.EarlyIndustrial, TechLevel.HiTech, 5000, -150, 100, null, null, 3500, 5000, 9);
    ...
    GoodsList(String name, TechLevel mtlp, TechLevel mtlu, TechLevel ttp, int base, int ipl, int var, Resources cr, Resources er, int mtl, int mth, int order) {
        this.name = name;
        this.mtlp = mtlp;
        this.mtlu = mtlu;
        this.ttp = ttp;
